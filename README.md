...
<p align="center">
  <img src="./首页.png" alt="首页 — 知识库总览" width="720" />
  <br />
  <em>首页 — 知识分类总览与搜索入口</em>
</p>

<p align="center">
  <img src="./详情1.png" alt="详情页 — 沉浸式阅读" width="720" />
  <br />
  <em>详情页 — Markdown 渲染与沉浸式阅读体验</em>
</p>

<p align="center">
  <img src="./面试问点1.png" alt="面试问点 — 题目详解" width="720" />
  <br />
  <em>面试问点 — 知识点深度解析展示</em>
</p>

<p align="center">
  <img src="./详情2.png" alt="详情页 — 目录导航" width="720" />
  <br />
  <em>详情页 — 自动目录导航与滚动追踪</em>
</p>

<p align="center">
  <img src="./面试问点2.png" alt="面试问点 — 面试题解析" width="720" />
  <br />
  <em>面试问点 — 面试真题与答案解析</em>
</p>
...
<p align="center">
  <a href="https://hushaoyu.github.io/faceNoteSite/"><strong>👉 面试知识库 PWA 应用</strong></a>
</p>

### 📲 安装到设备（推荐）

使用 Chrome、Edge 或 Safari 浏览器打开上述链接，根据浏览器提示将应用**添加到主屏幕**或**安装**到设备。安装后即可离线使用，获得更快捷的访问体验。
...
<p align="center">
  <img src="./wechat.png" alt="微信二维码" width="200" />
</p>

<p align="center">
  <em>扫码添加微信，一起交流前端面试与技术成长</em>
</p>