import{x as T,y as w,j as h,p as k}from"./index-BiiXOMiE.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const j=n=>n.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),A=(n,e)=>({size:i,strokeWidth:o=2,absoluteStrokeWidth:s,color:a,class:r,...p},{attrs:d,slots:l})=>T("svg",{...y,width:i||y.width,height:i||y.height,stroke:a||y.stroke,"stroke-width":s?Number(o)*24/Number(i):o,...d,class:["lucide",`lucide-${j(n)}`],...p},[...e.map(m=>T(...m)),...l.default?[l.default()]:[]]);/**
 * @license lucide-vue-next v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Cn=A("HeartIcon",[["path",{d:"M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z",key:"c3ymky"}]]),I=`---
...
> **更新日志**
> - 2026-07-01: 从基础版升级为深度解析版本，增加核心概念、布局规则、BFC 与 IFC 对比和面试问答`,H=`---
title: "元素居中的方式"
category: "CSS"
...
> **更新日志**
> - 2026-07-01: 从基础版升级为深度解析版本，增加核心概念、高级技巧、响应式设计和面试问答`,L=`---
title: "隐藏元素的方式"
category: "CSS"
...
| 可折叠内容 | height: 0 + overflow: hidden |`,N=`---
title: "重排与重绘"
category: "CSS"
...
> **更新日志**
> - 2026-07-01: 从基础版升级为深度解析版本，增加边界情况处理、手写实现、性能对比和面试问答`,W=`---
...
> **更新日志**
> - 2026-07-01: 从基础版升级为深度解析版本，增加动态加载、高级特性、多语言路由和面试问答`,q=`---
...
> **更新日志**
> - 2026-07-01: 从基础版升级为深度解析版本，增加事件循环、进程管理、微服务架构和面试问答`,X=`---
...
> **更新日志**
> - 2026-07-01: 从基础版升级为深度解析版本，增加作用域链、暂时性死区原理、内存模型和面试问答`,J=`---
...
> **更新日志**
> - 2026-07-01: 从基础版升级为深度解析版本，增加动态高度实现、生产级优化、React/Vue 实战和面试问答`,K=`---
...
> **更新日志**
> - 2026-07-01: 从基础版升级为深度解析版本，增加强缓存/协商缓存详解、缓存流程、刷新机制、策略实践和面试问答`,Q=`---
...
> **更新日志**
> - 2026-07-01: 从基础版升级为深度解析版本，增加请求响应结构、状态码详解、头部字段、缓存机制、HTTP/2 和面试问答`,Y=`---
...
> - [Inside Fiber: React 的 reconciler 内部实现](https://indepth.dev/posts/1008/inside-fiber-in-depth-overview-of-the-new-reconciliation-algorithm-in-react) — InDepth 的深度源码分析`,sn=`---
...
> **更新日志**
> - 2026-07-01: 从基础版升级为深度解析版本，增加目录结构、Vue2/Vue3 对比、Pinia 实战、面试问答和选型建议`,cn=`---
...
> **更新日志**
> - 2026-07-01: 从基础版升级为深度源码级解析版本，增加目录结构、源码分析、面试问答和最佳实践`,ln=`---
...
> **更新日志**
> - 2026-07-01: 从基础版升级为深度解析版本，增加 Mixins 问题分析、Composables 实现、迁移指南和面试问答`,un=`---
...
> **更新日志**
> - 2026-07-01: 从基础版升级为深度对比版本，增加响应式原理、性能优化、迁移指南和面试问答`,pn=`---
title: "面试题目录"
...
- **2026-06-24**: 识别 todo/images 下的图片，创建大量知识库文档，包括 JavaScript、CSS、Vue、Network、Build、Other 等分类`,dn=/^---\s*\n([\s\S]*?)\n---\s*\n/;function mn(n){const e={};return n.split(`
`).forEach(o=>{const s=o.match(/^(\w+):\s*(.+)$/);if(s){const a=s[1];let r=s[2].trim();r.startsWith('"')&&r.endsWith('"')?r=r.slice(1,-1):r.startsWith("[")&&r.endsWith("]")&&(r=JSON.parse(r)),e[a]=r}}),e}function fn(n){const e=n.match(dn);let i={title:"",category:"",tags:[],difficulty:"medium",filePath:"",lastModified:""},o=n;if(e){const a=mn(e[1]);i={title:a.title||"",category:a.category||"",tags:a.tags||[],difficulty:a.difficulty||"medium",filePath:"",lastModified:""},o=n.slice(e[0].length)}const s=hn(o);return{meta:i,content:o,toc:s}}function hn(n){const e=/^(#{2,3})\s+(.+)$/gm,i=[];let o;for(;(o=e.exec(n))!==null;){const s=o[1].length,a=o[2].trim(),r=a.toLowerCase().replace(/[^a-z0-9]+/g,"-");i.push({id:r,text:a,level:s})}return i}function gn(n){const e=n.split(`
`),i=[];let o="";return e.forEach(s=>{const a=s.match(/^###\s+(.+)$/);if(a){o=a[1];return}const r=s.match(/^\|\s*\[(.+?)\]\((.+?)\)\s*\|\s*(.+?)\s*\|\s*(.+?)\s*\|\s*$/);if(r){const p=r[1],d=r[2],l=r[3].trim(),g={简单:"easy",中等:"medium",高:"hard"}[l]||"medium",v=r[4].split(",").map(t=>t.trim()).filter(Boolean);i.push({title:p,category:o,tags:v,difficulty:g,filePath:d,lastModified:""})}}),i}function vn(n,e,i){if(!e.trim())return[];const o=e.toLowerCase(),s=[];return n.forEach(a=>{let r=0;const p=[];a.title.toLowerCase().includes(o)&&(r+=50,p.push({text:a.title,highlight:C(a.title,o)})),a.tags.forEach(l=>{l.toLowerCase().includes(o)&&(r+=20,p.push({text:l,highlight:C(l,o)}))});const d=i.get(a.filePath);if(d){const l=d.toLowerCase();if(l.includes(o)){r+=30;const m=l.indexOf(o),g=Math.max(0,m-30),v=Math.min(d.length,m+o.length+30),t=d.slice(g,v);p.push({text:t,highlight:C(t,o)})}}r>0&&s.push({document:a,matches:p,score:r})}),s.sort((a,r)=>r.score-a.score)}function C(n,e){const i=new RegExp(`(${e})`,"gi");return n.replace(i,'<mark class="bg-accent-500 text-white px-0.5 rounded">$1</mark>')}const x="knowledge_base_favorites";function b(){try{const n=localStorage.getItem(x);return n?JSON.parse(n):[]}catch{return[]}}function bn(n){const e=b();e.some(o=>o.filePath===n.filePath)||(e.push(n),localStorage.setItem(x,JSON.stringify(e)))}function Sn(n){const e=b().filter(i=>i.filePath!==n);localStorage.setItem(x,JSON.stringify(e))}function P(n){return b().some(e=>e.filePath===n)}const xn=w("knowledge",()=>{const n=h([]),e=h(new Map),i=h(null),o=h(null),s=h([]),a=h(!1),r=k(()=>{const t=new Map;n.value.forEach(c=>{t.set(c.category,(t.get(c.category)||0)+1)});const u={"JavaScript/TypeScript":"Code",CSS:"Palette",Vue:"Box",React:"Atom",Network:"Globe",Browser:"Monitor",Build:"Package",Other:"FileQuestion",AI:"Brain",Security:"Shield",Performance:"Zap",SystemDesign:"Network",Algorithms:"Binary",Architecture:"Layers"};return Array.from(t.entries()).map(([c,f])=>({name:c,label:c,icon:u[c]||"FileText",count:f}))}),p=k(()=>{let t=[...n.value];return i.value&&(t=t.filter(u=>u.category===i.value)),o.value&&(t=t.filter(u=>u.difficulty===o.value)),t.sort((u,c)=>u.title.localeCompare(c.title))});async function d(){a.value=!0;try{const t=Object.assign({"../knowledgeBase/AI/prompt-engineering.md":I,"../knowledgeBase/Browser/css-reflow-repaint.md":M,"../knowledgeBase/Browser/url-lifecycle.md":O,"../knowledgeBase/Build/build-optimization.md":E,"../knowledgeBase/Build/webpack-chunk.md":R,"../knowledgeBase/CSS/bfc.md":D,"../knowledgeBase/CSS/element-centering.md":H,"../knowledgeBase/CSS/flexbox-layout.md":F,"../knowledgeBase/CSS/hide-element.md":L,"../knowledgeBase/CSS/reflow-repaint.md":N,"../knowledgeBase/JavaScript/closure.md":B,"../knowledgeBase/JavaScript/debounce-throttle.md":_,"../knowledgeBase/JavaScript/deep-shallow-copy.md":V,"../knowledgeBase/JavaScript/event-loop.md":W,"../knowledgeBase/JavaScript/i18n.md":U,"../knowledgeBase/JavaScript/nodejs-capabilities.md":q,"../knowledgeBase/JavaScript/reflect.md":X,"../knowledgeBase/JavaScript/this-binding.md":z,"../knowledgeBase/JavaScript/var-let-const.md":G,"../knowledgeBase/JavaScript/virtual-list.md":J,"../knowledgeBase/Network/cors.md":K,"../knowledgeBase/Network/http-cache.md":$,"../knowledgeBase/Network/http-protocol.md":Q,"../knowledgeBase/Network/mcp-principle.md":Y,"../knowledgeBase/Network/sse-polling.md":Z,"../knowledgeBase/Network/xss-attack.md":nn,"../knowledgeBase/Other/career-plan.md":en,"../knowledgeBase/Other/git-operations.md":tn,"../knowledgeBase/Other/resign-reasons.md":on,"../knowledgeBase/Other/self-introduction.md":rn,"../knowledgeBase/React/react-core-source.md":an,"../knowledgeBase/Vue/component-communication.md":sn,"../knowledgeBase/Vue/reactivity-principle.md":cn,"../knowledgeBase/Vue/vue-mixins.md":ln,"../knowledgeBase/Vue/vue2-vs-vue3.md":un,"../knowledgeBase/index.md":pn}),u=t["../knowledgeBase/index.md"]||"";n.value=gn(u),n.value.forEach(c=>{const f=`../knowledgeBase/${c.filePath}`,S=t[f];S?e.value.set(c.filePath,S):e.value.set(c.filePath,"")}),s.value=b()}catch(t){console.error("Failed to load documents:",t)}finally{a.value=!1}}function l(t){const u=e.value.get(t);if(!u)return null;const c=fn(u);c.meta.filePath=t;const f=n.value.find(S=>S.filePath===t);return f&&(c.meta.category=f.category,c.meta.lastModified=f.lastModified),c}function m(t){return vn(n.value,t,e.value)}function g(t){P(t.filePath)?Sn(t.filePath):bn(t),s.value=b()}function v(t){return P(t)}return{documents:n,contentMap:e,currentCategory:i,currentDifficulty:o,favorites:s,isLoading:a,categories:r,filteredDocuments:p,loadDocuments:d,getDocumentContent:l,search:m,toggleFavorite:g,isDocFavorite:v}});export{Cn as H,A as c,xn as u};
